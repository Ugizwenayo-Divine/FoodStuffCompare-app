...
import OrdersChecker from '../../middlewares/ordersChecker';
import orderMiddleware from '../../middlewares/orderValidation';
...
ordersRouter.post('/add', isUserLoggedIn, doesOrderedProductExist, addOrders);
